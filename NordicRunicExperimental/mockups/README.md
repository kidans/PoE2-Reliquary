...
2. Can we replace ornamental reliquary/gold-blue assets with deterministic SVG/CSS geometry?
...
- Should the rune geometry be sharper and more brutal?
- Should user hue replace all cyan marks exactly, or should frost-cyan remain the default accent preset?
- Should the floating spine use diamond runestones or vertical stave plates?
